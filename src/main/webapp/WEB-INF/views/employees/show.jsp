...
<c:import url="/WEB-INF/views/layout/app.jsp">
	<c:param name="content">
		<h2>id : A${employee.id}の従業員情報　詳細ページ</h2>
		...
		<table>
			<tbody>
				...
				<tr>
					<th>登録日時</th>
					<fmt:parseDate value="${employee.createdAt }" pattern="yyyy-MM-dd'T'HH:mm:ss" var="creatDay" type="date" />
					<td><fmt:formatDate value="${createDay }" pattern="yyyy-MM-dd HH:mm:ss" /></td>
				</tr>
				<tr>
					<th>更新日時</th>
					<fmt:parseDate value="${employee.updatedAt }" pattern="yyyy-MM-dd'T'HH:mm:ss" var="uppdateDay" type="date" />
